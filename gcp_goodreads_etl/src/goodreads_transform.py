...
class GoodreadsTransform:
    ...
    def __init__(self, spark):
        self._spark = spark
        self._load_path = 'gs://' + config.get('BUCKET', 'WORKING_ZONE')
        self._save_path = 'gs://' + config.get('BUCKET', 'PROCESSED_ZONE')
    ...
    def transform_author_dataset(self):
        ...
        deduped_author_df\
            .repartition(10)\
            .write\
            .csv(path = self._save_path + '/authors/', sep = ',', mode='overwrite', header=True, timestampFormat = 'yyyy-MM-dd HH:mm:ss.SSS', quote = '"', escape = '"')
    ...
    def transform_reviews_dataset(self):
        ...
        deduped_reviews_df\
            .repartition(10)\
            .write\
            .csv(path = self._save_path + '/reviews/', sep = ',', mode='overwrite', header=True, timestampFormat = 'yyyy-MM-dd HH:mm:ss.SSS', quote = '"', escape = '"')
    ...
    def transform_books_dataset(self):
        ...
        deduped_books_df\
            .repartition(10)\
            .write\
            .csv(path = self._save_path + '/books/', sep = ',', mode='overwrite', header=True, timestampFormat = 'yyyy-MM-dd HH:mm:ss.SSS', quote = '"', escape = '"')
    ...
    def tranform_users_dataset(self):
        ...
        deduped_users_df\
            .repartition(10)\
            .write\
            .csv(path = self._save_path + '/users/', sep = ',', mode='overwrite', header=True, timestampFormat = 'yyyy-MM-dd HH:mm:ss.SSS', quote = '"', escape = '"')
